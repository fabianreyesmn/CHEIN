        ...
        <div class="tarjetas">
            <?php
                if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['filtrar'])){
                    ...
                    $sql = "SELECT * FROM producto WHERE Categoria_P = 'Ropa' AND Precio_P - Descuento_P >= $precio_min AND Precio_P - Descuento_P <= $precio_max AND Existencias_P >= $existencias_min";
